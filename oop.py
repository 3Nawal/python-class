...
# Actual program
savings = SavingsAccount("Asiya", 1000, 5)  # Creating Asiya's savings account with 1,000 balance and 5% interest rate
checking = CheckingAccount("Asiya", 500, 200)  # Creating Asiya's checking account with 500 balance and 200 overdraft
